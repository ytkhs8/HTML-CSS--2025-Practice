...
(function(){
  const DICT = {
    en: {
      ...
      'materials.landscape.city.title': 'Ginza: Then and Now',
      'materials.landscape.city.before': 'Present-day Ginza area',
      'materials.landscape.city.after': 'Ginza area in the past',
      ...
      'materials.people.cosplay.title': 'Everyday outfit vs Halloween cosplay',
      ...
      'materials.face.season.winter': 'Firm winter face',
      ...
      'materials.face.age.after': 'Face at age mid-twenties',
    ...
    ja: {
      ...
      'materials.landscape.city.title': '現在と昔の銀座の変貌',
      'materials.landscape.city.before': '現在の銀座和光時計台周辺',
      'materials.landscape.city.after': '昔の銀座和光時計台周辺',
      ...
      'materials.people.cosplay.title': '普段の姿とハロウィンのコスプレをした姿の対比',
      'materials.people.cosplay.before': '普段着の姿',
      'materials.people.cosplay.after': 'ハロウィンのコスプレの姿',
