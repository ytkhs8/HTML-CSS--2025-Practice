...
(function(){
  const DICT = {
    en: {
      ...
      'materials.face.cosmetic-surgery.title': 'Cosmetic surgery results',
      'materials.face.cosmetic-surgery.before': 'Before treatment',
      'materials.face.cosmetic-surgery.after': 'After treatment',
      ...
      'materials.face.age.after': 'Face at age twenty-three',
      'materials.category.results': 'Outcomes',
      'materials.result.cleaning.title': 'Cleaning before & after',
      'materials.result.cleaning.before': 'Before cleaning',
      'materials.result.cleaning.after': 'After cleaning',
    ...
    ja: {
      ...
      'materials.face.cosmetic-surgery.title': '美容整形施術前後の顔の対比',
      'materials.face.cosmetic-surgery.before': '施術前',
      'materials.face.cosmetic-surgery.after': '施術後',
      ...
      'materials.face.age.after': '２３歳の頃',
      'materials.category.results': '成果物',
      'materials.result.cleaning.title': '掃除をした箇所のビフォーアフター',
      'materials.result.cleaning.before': '掃除前の状態',
      'materials.result.cleaning.after': '掃除後の状態',
